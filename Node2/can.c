...
void can_init(void){
  mcp2515_init();
  mcp2515_bitModify(MCP_CANCTRL, MODE_MASK, MODE_NORMAL); // Switching to loop-back mode: change MODE_NORMAL to MODE_LOOPBACK
  mcp2515_bitModify(MCP_CANINTE, 0x03, MCP_RX_INT);       // Interrupt
